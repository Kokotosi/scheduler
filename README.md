...
Experimental Java/JVM scheduler library and learning project.

This repository is intentionally set up to optimize for three goals at the same time:

1. Learn disciplined library design by building a real library instead of a throwaway demo app.
...
Gradle is a reasonable future option if the project grows into a multi-module build. Starting with Maven here is a pragmatic bootstrap decision, not a long-term ideology.
